  ...
  useEffect(() => {
    const loadInitialData = async () => {
      ...
      try {
        ...
        if (data.length === 0) {
          toast({
            title: "Using demo services",
            description: "Database not configured yet. Using sample services for demo.",
            variant: "default",
          })
        }
      } catch (error) {
        ...
        const fallbackServices = [
          ...
          { id: "2", name: "Gel Manicure", description: "Long-lasting gel polish manicure", duration: 60, price: 35.0 },
          {
            id: "3",
        ...
        toast({
          title: "Using demo services",
          description: "Could not connect to database. Using sample services for demo.",
          variant: "default",
        })
      } finally {
        setIsLoading(false)
